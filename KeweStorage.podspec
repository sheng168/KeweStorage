#
#  Be sure to run `pod spec lint KeweWords.podspec' to ensure this is a
...
This is a long description of what my pod does. In order for CocoaPods to accept this, my description must be longer than the summary.
  ...
  s.author             = { "Jin Yu" => "jin.yu@clearme.com" }
  # Or just: s.author    = "Jin Yu"
  # s.authors            = { "Jin Yu" => "jin.yu@clearme.com" }
  # s.social_media_url   = "http://twitter.com/Jin Yu"
